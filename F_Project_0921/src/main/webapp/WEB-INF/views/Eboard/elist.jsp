      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.html">MEMBER</a></span> <span>BOARD</span></p>
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
            ...
            <div class=" form-group" style="width:125px; text-align:center; float: right; display: flex; margin-bottom:50px;"><button id='regBtn' type="button" style="text-align:center;" class="btn btn-xs pull-right form-group">리뷰 작성</button></div>
            </sec:authorize>
			</div>
