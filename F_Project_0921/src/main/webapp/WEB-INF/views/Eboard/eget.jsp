...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">EBoard Read</h1>
  </div>
  <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">EBoard Read Page</div>
      <!-- /.panel-heading -->
...
<button data-oper='modify' class="btn btn-default" onclick="location.href='/board/modify?bno=<c:out value="${board.bno}" /> '">Modify 수정!</button>
 -->        
        ...
        <button data-oper='modify' class="btn btn-default">Modify 수정!</button>
        </c:if>
        </sec:authorize>
...
<button data-oper='list' class="btn btn-info" onclick="location.href='/Eboard/elist'">List 보여주세요!</button>
...
<!-- Page572 ~ 573까지 소스 코딩 끝 -->
      	 ...
      	 <!-- Page 419 댓글 목록 상단 오른쪽에 버튼을 하나 추가해서
      	      ...
      	      <!-- Page718 아래 1줄 소스 수정 코딩 sec authorize 적용해서
      	      	...
      	      	<i class="fa fa-comments fa-fw"></i> Reply!!! <sec:authorize access="isAuthenticated()">
      	      		<button id="addReplyBtn" class="btn btn-primary btn-xs pull-right">New Reply!!!</button></sec:authorize>
      	      </div>
