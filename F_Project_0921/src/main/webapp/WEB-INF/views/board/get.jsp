  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <label>순번</label> <input class="form-control" name='bno'
...
<!-- Page572 ~ 573까지 소스 코딩 끝 -->
      	 ...
      	 <!-- Page 419 댓글 목록 상단 오른쪽에 버튼을 하나 추가해서
      	      ...
      	      <!-- Page718 아래 1줄 소스 수정 코딩 sec authorize 적용해서
      	      	...
      	      	<i class="fa fa-comments fa-fw"></i> <br> <sec:authorize access="isAuthenticated()">
      	      		<button id="addReplyBtn" class="btn btn-primary btn-xs pull-right">댓글 작성</button></sec:authorize>
      	      </div>
      	      <hr>
...
<div class="modal-footer">
        ...
        <button id='modalRegisterBtn' type="button" class="btn btn-primary">수정</button>
        <button id='modalCloseBtn' type="button" class="btn btn-default">삭제</button>
      </div>          </div>
          <!-- /.modal-content -->
        </div>
        <!-- /.modal-dialog -->
