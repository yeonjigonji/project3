						  ...
						  <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
							<div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="../../resources/img/gambas.jpg" alt="..." />
							  <div class="card-body ps-0">
								...
								<div><span class="text-warning me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-primary">새우 냠냠 감바스</span></div><hr><span class="text-1000 fw-bold">8900원</span>
							  </div>
							</div>
						  </div>
						  <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
							<div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="../../resources/img/stake.jpg" alt="..." />
							  <div class="card-body ps-0">
								<h5 class="fw-bold text-1000 text-truncate mb-1">스테이크</h5>
								<div><span class="text-warning me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-primary">스테이크 냠냠</span></div><hr><span class="text-1000 fw-bold">12900원</span>
							  </div>
							</div>
						  </div>
						  <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
							<div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="../../resources/img/tang4.jpg" alt="..." />
							  <div class="card-body ps-0">
								...
								<div><span class="text-warning me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-primary">대한민국 집밥</span></div><hr><span class="text-1000 fw-bold">6000원</span>
							  </div>
							</div>
						  </div>
						  <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
							<div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="../../resources/img/tang3.jpg" alt="..." />
							  <div class="card-body ps-0">
								...
								<div><span class="text-warning me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-primary">뜨끈뜨끈 육개장</span></div><hr><span class="text-1000 fw-bold">5800원</span>
							  </div>
							</div>
						  </div>
						  <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
							<div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="../../resources/img/tang2.jpg" alt="..." />
							  <div class="card-body ps-0">
								...
								<div><span class="text-warning me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-primary">아 따뜻하다</span></div><hr><span class="text-1000 fw-bold">6000원</span>
							  </div>
							</div>
						  </div>
						</div>
