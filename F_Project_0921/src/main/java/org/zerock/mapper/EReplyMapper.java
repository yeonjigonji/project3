...
public interface EReplyMapper {
	...
	// 구성합니다.
	public List<EReplyVO> egetListWithPaging(
			@Param("cri") ECriteria cri,
			@Param("bno") Long bno);
	...
	public int egetCountByBno(Long bno);
