...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <center><div class="panel-heading">리뷰 등록</div></center>
      
      <hr>
      <!-- /.panel-heading -->
      <div class="panel-body">

        <form role="form" action="/Eboard/eregister" method="post" name="myform">
        ...
        input type hidden 형식으로 아래와 같이 추가해 줍니다.  -->
         <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
          ...
          <button onclick="add()" type="submit" class="btn btn-default">리뷰 등록</button>
          <button data-oper='list' class="btn btn-default" onclick="location.href='/Eboard/elist'">목록</button>
          <br>
          <br>
        </form>
