...
public class EReplyMapperTests {
	...
	public void testRead() {
		...
		EReplyVO vo = mapper.read(targetRno);
	...
	public void testList() {
		...
		List<EReplyVO> replies = mapper.getListWithPaging(cri, bnoArr[0]);
	...
	public void testList2() {
		...
		// 721003L
		List<EReplyVO> replies = mapper.getListWithPaging(cri, 721003L);
		replies.forEach(reply -> log.info(reply));
	}
